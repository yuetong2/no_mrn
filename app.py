...
if uploaded:
    ...
    ocr_data = pytesseract.image_to_data(rgb, output_type=pytesseract.Output.DICT, config="--oem 1 --psm 6")
    ...
    if success:
        st.download_button("Download masked image", buffer.tobytes(), "masked_output.jpg", mime="image/jpeg")
else:
